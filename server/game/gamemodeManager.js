...
const { Craftras } = require("./gamemodes/scripts/craftras.js");
...
class gamemodeManager {
    constructor() {
        ...
        this.gameCraftras = new Craftras(global.gameManager);
    }
    ...
    request(type) {
        if (type == "start") {
            ...
            if (Config.craftras) this.gameCraftras.start();
        }
        if (type == "loop") {
        ...
        if (type == "quickloop") { // Mainly for sandbox and trainwars only, but you can also put your own gamemode loop here incase the regular loop doesnt fit.
            ...
            if (Config.craftras) this.gameCraftras.update();
        }
    }
    ...
    terminate() {
        ...
        if (Config.craftras) this.gameCraftras.terminate();
    }
    ...
    redefine(theshit) {
        ...
        this.gameCraftras.redefine(theshit);
    }
}
