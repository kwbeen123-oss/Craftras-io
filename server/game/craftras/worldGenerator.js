const { getWorldTerrainType } = require("./worldTerrainMap.js");
...
function getWorld2OreBlock(x, y, seed) {
    ...
    if (hash01(localX, y, seed + 22_102) < 0.0132378) return BLOCKS.IRON_ORE;
    if (hash01(localX, y, seed + 22_103) < goldChance) return BLOCKS.GOLD_ORE;
    if (hash01(localX, y, seed + 22_104) < 0.011512359141258607) return BLOCKS.GOLD_ORE;
    return BLOCKS.ROCK;
}
