    ...
    collide = (instance, other) => {
        ...
        switch (true) {
            case instance.isPortal || other.isPortal:
                ...
                break;
            case (instance.craftrasChallengeActor && other.craftrasChallengeHostile) ||
                (other.craftrasChallengeActor && instance.craftrasChallengeHostile):
                // Challenge damage is handled by the Craftras AI, so hostiles
                // should not physically pin the escort in place.
                break;
