...
module.exports = {
    ...
    host: primaryHost, // Game server domain. Hosted deployments use the current public request host on the client.
    port: primaryPort, // Hosting providers supply PORT; local development falls back to 3000.
    ...
    servers: [
        ...
        },
        {
            ...
            gamemode: ['craftras_world1_challenge'],
            player_cap: 20,
            featured: false,
            hidden: true,
            unlisted: true,
