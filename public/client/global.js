...
const global = {
    ...
    craftrasTeamHostLabels: new Map(),
    craftrasChallengeEntry: {
        open: false,
        teamName: "",
        memberCount: 1,
        isHost: true,
    ...
    craftrasWorld: {
        ...
        floorChunks: new Map(),
        floorChunkEntries: new Map(),
        hitEffects: new Map(),
        blockUpdateVersions: new Map(),
        caveSurfaceDepthCache: new Map(),
        cavePrewarmSeenChunks: new Set(),
        cavePrewarmQueue: [],
        cavePrewarmCursor: 0,
        caveNextPrewarmAt: 0,
    ...
    craftrasChallengeInventoryTemporary: false,
    craftrasHotbar: {
        active: true,
        selected: 0,
        slots: [
    ...
    craftrasRouteMarkers: [],
    craftrasTextStoryMarkers: new Map(),
    craftrasInventory: {
        active: true,
        open: false,
        drag: null,
